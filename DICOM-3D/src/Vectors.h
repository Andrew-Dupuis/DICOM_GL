// Developed with Reference to Vectors class by Song Ho Ahn (song.ahn@gmail.com)
#pragma once
...
struct Vector2
{
	...
	Vector2     operator/(const Vector2& rhs) const;    // divide each element
    Vector2&    operator/=(const float scale);          // scale and update this object
...
#pragma region Inline functions for Vector2
...
#pragma region Inline functions for Vector3
...
#pragma region Inline functions for Vector4
